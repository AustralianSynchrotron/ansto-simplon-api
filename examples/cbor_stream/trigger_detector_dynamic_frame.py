"""
Example script of triggering the detector in dynamic frame mode. With each trigger,
the beam center x coordinate is changed, to demonstrate the ability of the API to
